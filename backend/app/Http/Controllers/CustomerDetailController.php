    ...
    public function show($accountNo): JsonResponse
    {
        try {
            ...
            $data = [
                ...
                'proof_of_billing_url' => $customer->proof_of_billing_url,
                'government_valid_id_url' => $customer->government_valid_id_url,
                'second_government_valid_id_url' => $customer->second_government_valid_id_url,
                'document_attachment_url' => $customer->document_attachment_url,
                'other_isp_bill_url' => $customer->other_isp_bill_url,
