...
const StaggeredListDetails: React.FC<StaggeredListDetailsProps> = ({ staggered, onClose, onViewCustomer }) => {
            ...
            <div className="space-y-1">
              ...
              <div className={`flex py-2 ${isDarkMode ? 'border-b border-gray-800' : 'border-b border-gray-300'
                ...
                <div className="text-red-400 flex-1 font-medium flex items-center">
                  ...
                  <button
                    onClick={() => onViewCustomer?.(staggered.billing_account?.account_no || staggered.account_no)}
                    className={`ml-2 p-1 rounded transition-colors ${isDarkMode ? 'text-gray-400 hover:text-white hover:bg-gray-700' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-200'
                      }`}
