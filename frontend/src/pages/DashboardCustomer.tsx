                ...
                <View style={{ gap: 32 }}>
                    ...
                    <View style={{ gap: 16 }}>
                        ...
                        >
                            ...
                            <Text style={{ fontSize: 16, fontWeight: '600', color: '#334155', marginBottom: 4 }}>No Referrals Yet</Text>
                            <Text style={{ fontSize: 14, color: '#64748b', textAlign: 'center' }}>Start referring friends and family to earn rewards!</Text>
                        </View>
