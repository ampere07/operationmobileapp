      ...
      return (
        <View>
          ...
          <View style={{ width: '100%', paddingHorizontal: 12, paddingVertical: 8, borderRadius: 4, borderWidth: 1, borderColor: isDarkMode ? '#374151' : '#d1d5db', backgroundColor: isDarkMode ? '#1f2937' : '#ffffff' }}>
            <Pressable onPress={() => handleBooleanChange(selectedColumn.key, '')}>
              <Text style={{ color: isDarkMode ? '#ffffff' : '#111827', paddingVertical: 8 }}>All</Text>
            </Pressable>
            <Pressable onPress={() => handleBooleanChange(selectedColumn.key, 'true')}>
              <Text style={{ color: isDarkMode ? '#ffffff' : '#111827', paddingVertical: 8 }}>Yes</Text>
            </Pressable>
            <Pressable onPress={() => handleBooleanChange(selectedColumn.key, 'false')}>
              <Text style={{ color: isDarkMode ? '#ffffff' : '#111827', paddingVertical: 8 }}>No</Text>
            </Pressable>
          </View>
        </View>
      );
            ...
            <View style={{ height: '100%', flexDirection: 'column' }}>
              ...
              <View style={{ paddingHorizontal: 24, paddingVertical: 16, borderTopWidth: 1, borderTopColor: isDarkMode ? '#374151' : '#e5e7eb' }}>
                <View style={{ flexDirection: 'row', gap: 12 }}>
                  ...
                  >
                    <Text style={{ color: isDarkMode ? '#ffffff' : '#111827', textAlign: 'center', fontWeight: '500' }}>Clear</Text>
                  </Pressable>
                  <Pressable
                    onPress={handleApply}
